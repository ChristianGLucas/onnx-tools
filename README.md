...
https://dev.axiomide.com/marketplace/christiangeorgelucas/onnx-tools@0.1.1
...
```bash
axiom invoke christiangeorgelucas/onnx-tools/RunInference --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/onnx-tools/0.1.1/RunInference \
...
> `axiom inspect node christiangeorgelucas/onnx-tools/RunInference`.
